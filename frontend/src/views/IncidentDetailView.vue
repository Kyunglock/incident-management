<template>
  <div class="max-w-3xl mx-auto">
    ...
    <div v-if="incident" class="mt-4">
      <div class="card mb-6">
        <h2 class="text-lg font-bold text-gray-800">장애 #{{ incident.id }}</h2>
      ...
      <section class="card mb-6">
        ...
        <div class="space-y-3">
          <div>
            ...
            <textarea v-model="analysisForm.errorLogs" rows="4" class="input font-mono text-xs" placeholder="관련 에러 로그를 붙여넣으세요"></textarea>
          </div>
